...
import com.ada.mapaAstral.Enum.Sign;
import java.time.*;
import java.time.format.DateTimeFormatter;
import java.time.format.FormatStyle;
import java.util.Set;

public class AstrologyChartService {
    ...
    public String buscaSignoPorEnun(LocalDateTime datanascimento) {
        ...
        for (Sign signo : Sign.values()) {
            if (isWithinRange(monthDayNascimento, signo.getFirstDay(), signo.getLastDay())) {
                System.out.println(signo.getName());
    ...
    public String buscaPorSigno(LocalDate datanascimento) {
        ...
        MonthDay scorpioStartDate = MonthDay.of(10, 23);
        MonthDay scorpioEndDate = MonthDay.of(11, 21);
        ...
        if (isWithinRange(monthDayNascimento, ariesStartDate, ariesEndDate)) {
            ...
            return "Sagitario";
        } else if (isWithinRange(monthDayNascimento, scorpioStartDate, scorpioEndDate)) {
            return "Escorpião";
        }
